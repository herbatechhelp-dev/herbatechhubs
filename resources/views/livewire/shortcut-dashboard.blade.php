            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div class="flex max-w-5xl flex-col gap-6 sm:flex-row sm:items-center sm:gap-6 lg:gap-5">
                    ...
                    <div class="space-y-4 lg:max-w-md">
                        ...
                        <div class="space-y-3">
                            <h1 class="font-display text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl dark:text-white">
                                {{ $hubSettings->title }}
                            </h1>
                            <p class="max-w-2xl text-sm leading-6 text-slate-600 sm:text-base dark:text-slate-300">
                            ...
                            <div class="flex min-w-0 items-center gap-4">
                                <div class="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-white/40 bg-white/75 shadow-lg shadow-slate-900/5 dark:border-white/10 dark:bg-white/10">
                                    @if ($shortcut->icon_path)
                                        <img src="{{ $shortcut->icon_path }}" alt="{{ $shortcut->title }} favicon" class="size-8 rounded-lg object-cover">
                                    @else
